export class AboutPage {
    ...
    private render(): void {
        this.el.innerHTML = `
            ...
            <div style="display: flex; flex-direction: column; gap: 40px; max-width: 780px;">
                <!-- Section 01 -->
                <section style="display: flex; flex-direction: column; gap: 12px;">
                    ...
                    <h2 style="font-size: 18px; font-weight: 700; color: var(--text-primary); letter-spacing: -0.02em;">Digital Materiality & Simulation</h2>
                ...
                <section style="display: flex; flex-direction: column; gap: 12px;">
                    ...
                    <h2 style="font-size: 18px; font-weight: 700; color: var(--text-primary); letter-spacing: -0.02em;">Extended Position-Based Dynamics (XPBD)</h2>
                    <p style="font-size: 14px; color: var(--text-secondary); line-height: 1.7;">
                ...
                <section style="display: flex; flex-direction: column; gap: 12px;">
                    ...
                    <h2 style="font-size: 18px; font-weight: 700; color: var(--text-primary); letter-spacing: -0.02em;">Open Source Foundations</h2>
                    <p style="font-size: 14px; color: var(--text-secondary); line-height: 1.7;">
                    ...
                    <p style="font-size: 13px; color: var(--text-muted); line-height: 1.6; margin-top: 4px;">
                        References:<br/>
